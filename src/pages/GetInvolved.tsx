...
const volunteerOpportunities = [
  ...
  },
  {
    ...
    color: "from-sport-orange to-sport-orange",
    urgent: true
  }
];
      ...
      <main>
        ...
        <section className="bg-gradient-hero py-20">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="bg-card/10 rounded-xl p-6 backdrop-blur-sm">
                <Users className="h-12 w-12 text-foreground mx-auto mb-4" />
                <div className="text-2xl font-bold text-foreground">1,247</div>
                <div className="text-foreground/80">Active Volunteers</div>
              </div>
              <div className="bg-card/10 rounded-xl p-6 backdrop-blur-sm">
                <Calendar className="h-12 w-12 text-foreground mx-auto mb-4" />
                <div className="text-2xl font-bold text-foreground">156</div>
                <div className="text-foreground/80">Events This Year</div>
              </div>
              <div className="bg-card/10 rounded-xl p-6 backdrop-blur-sm">
                <Heart className="h-12 w-12 text-foreground mx-auto mb-4" />
                <div className="text-2xl font-bold text-foreground">89%</div>
                <div className="text-foreground/80">Volunteer Retention</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-card">
          <div className="container mx-auto px-6">
            <h2 className="text-4xl font-bold text-foreground text-center mb-4">Volunteer Opportunities</h2>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        <div className={`bg-gradient-to-br ${opportunity.color} rounded-full p-3`}>
                          <opportunity.icon className="h-6 w-6 text-foreground" />
                        </div>
                        <div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold text-foreground text-center mb-4">Make a Donation</h2>
        ...
        <section className="py-20 bg-card">
          <div className="container mx-auto px-6">
            <h2 className="text-4xl font-bold text-foreground text-center mb-4">Upcoming Events</h2>
            <p className="text-lg text-muted-foreground text-center mb-12">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-4xl font-bold text-foreground text-center mb-4">Get In Touch</h2>
              <p className="text-lg text-muted-foreground text-center mb-12">
              ...
              <div className="mt-8 text-center">
                <p className="text-muted-foreground mb-4">Prefer to call or email directly?</p>
