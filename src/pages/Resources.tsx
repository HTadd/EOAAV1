...
const resourceCategories = [
  {
    ...
    icon: Trophy,
    color: "bg-gradient-to-br from-sport-gold to-sport-gold",
    resources: [
      {
  ...
  },
  {
    ...
    icon: Play,
    color: "bg-gradient-to-br from-sport-blue to-sport-blue",
    resources: [
      {
  ...
  },
  {
    ...
    icon: Users,
    color: "bg-gradient-to-br from-sport-green to-sport-green",
    resources: [
      {
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-10 pr-4 py-3 rounded-full w-80 bg-input text-foreground placeholder:text-muted-foreground"
                />
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground">Competition Guides</div>
              </div>
            </div>
          </div>
        </section>
